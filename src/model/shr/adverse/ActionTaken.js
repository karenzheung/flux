...
class ActionTaken {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/adverse/ActionTaken' } };
    ...
    if (this.medicationChange != null) {
      inst['shr.medication.MedicationChange'] = typeof this.medicationChange.toJSON === 'function' ? this.medicationChange.toJSON() : this.medicationChange;
    }
    return inst;
  }
}
