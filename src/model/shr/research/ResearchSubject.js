...
class ResearchSubject extends Role {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/research/ResearchSubject' };
    if (this.value != null) {
    ...
    if (this.study != null) {
      inst['shr.research.Study'] = typeof this.study.toJSON === 'function' ? this.study.toJSON() : this.study;
    }
    if (this.status != null) {
      inst['shr.action.Status'] = typeof this.status.toJSON === 'function' ? this.status.toJSON() : this.status;
    }
    if (this.participationPeriod != null) {
      inst['shr.action.ParticipationPeriod'] = typeof this.participationPeriod.toJSON === 'function' ? this.participationPeriod.toJSON() : this.participationPeriod;
    }
