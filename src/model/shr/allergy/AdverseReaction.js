...
class AdverseReaction {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/allergy/AdverseReaction' } };
    if (this.allergenIrritant != null) {
      inst['shr.allergy.AllergenIrritant'] = typeof this.allergenIrritant.toJSON === 'function' ? this.allergenIrritant.toJSON() : this.allergenIrritant;
    }
    if (this.manifestation != null) {
      inst['shr.allergy.Manifestation'] = typeof this.manifestation.toJSON === 'function' ? this.manifestation.toJSON() : this.manifestation;
    }
