...
class AllergyIntolerance extends SpecializedFinding {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/allergy/AllergyIntolerance' };
    if (this.value != null) {
    ...
    if (this.substanceCategory != null) {
      inst['shr.allergy.SubstanceCategory'] = this.substanceCategory.map(f => f.toJSON());
    }
    if (this.verificationStatus != null) {
      inst['shr.allergy.VerificationStatus'] = typeof this.verificationStatus.toJSON === 'function' ? this.verificationStatus.toJSON() : this.verificationStatus;
    }
    if (this.type != null) {
    ...
    if (this.adverseReaction != null) {
      inst['shr.allergy.AdverseReaction'] = this.adverseReaction.map(f => f.toJSON());
    }
    if (this.onset != null) {
    ...
    if (this.mostRecentOccurrenceTime != null) {
      inst['shr.allergy.MostRecentOccurrenceTime'] = typeof this.mostRecentOccurrenceTime.toJSON === 'function' ? this.mostRecentOccurrenceTime.toJSON() : this.mostRecentOccurrenceTime;
    }
    return inst;
  }
}
