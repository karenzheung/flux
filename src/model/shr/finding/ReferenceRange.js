...
class ReferenceRange {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/finding/ReferenceRange' } };
    if (this.value != null) {
    ...
    if (this.applicableSubpopulation != null) {
      inst['shr.finding.ApplicableSubpopulation'] = typeof this.applicableSubpopulation.toJSON === 'function' ? this.applicableSubpopulation.toJSON() : this.applicableSubpopulation;
    }
    if (this.applicableAgeRange != null) {
      inst['shr.finding.ApplicableAgeRange'] = typeof this.applicableAgeRange.toJSON === 'function' ? this.applicableAgeRange.toJSON() : this.applicableAgeRange;
    }
    return inst;
  }
}
