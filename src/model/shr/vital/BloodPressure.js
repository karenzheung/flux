...
class BloodPressure extends VitalSign {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/vital/BloodPressure' };
    if (this.value != null) {
    ...
    if (this.headTiltAngle != null) {
      inst['shr.vital.HeadTiltAngle'] = typeof this.headTiltAngle.toJSON === 'function' ? this.headTiltAngle.toJSON() : this.headTiltAngle;
    }
    return inst;
  }
}
