...
class Dosage {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/medication/Dosage' } };
    if (this.doseAmount != null) {
      inst['shr.medication.DoseAmount'] = typeof this.doseAmount.toJSON === 'function' ? this.doseAmount.toJSON() : this.doseAmount;
    }
    if (this.timingOfDoses != null) {
      inst['shr.medication.TimingOfDoses'] = typeof this.timingOfDoses.toJSON === 'function' ? this.timingOfDoses.toJSON() : this.timingOfDoses;
    }
    if (this.asNeededIndicator != null) {
      inst['shr.medication.AsNeededIndicator'] = typeof this.asNeededIndicator.toJSON === 'function' ? this.asNeededIndicator.toJSON() : this.asNeededIndicator;
    }
    if (this.doseInstructionsText != null) {
      inst['shr.medication.DoseInstructionsText'] = typeof this.doseInstructionsText.toJSON === 'function' ? this.doseInstructionsText.toJSON() : this.doseInstructionsText;
    }
    if (this.additionalDoseInstruction != null) {
      inst['shr.medication.AdditionalDoseInstruction'] = this.additionalDoseInstruction.map(f => f.toJSON());
    }
    if (this.routeIntoBody != null) {
      inst['shr.medication.RouteIntoBody'] = typeof this.routeIntoBody.toJSON === 'function' ? this.routeIntoBody.toJSON() : this.routeIntoBody;
    }
    if (this.administrationMethod != null) {
      inst['shr.medication.AdministrationMethod'] = typeof this.administrationMethod.toJSON === 'function' ? this.administrationMethod.toJSON() : this.administrationMethod;
    }
    if (this.administrationBodySite != null) {
      inst['shr.medication.AdministrationBodySite'] = typeof this.administrationBodySite.toJSON === 'function' ? this.administrationBodySite.toJSON() : this.administrationBodySite;
    }
    if (this.maximumDosePerTimePeriod != null) {
      inst['shr.medication.MaximumDosePerTimePeriod'] = typeof this.maximumDosePerTimePeriod.toJSON === 'function' ? this.maximumDosePerTimePeriod.toJSON() : this.maximumDosePerTimePeriod;
    }
    return inst;
  }
}
