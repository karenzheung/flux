...
class Coverage {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/financial/Coverage' };
    if (this.type != null) {
      inst['shr.entity.Type'] = typeof this.type.toJSON === 'function' ? this.type.toJSON() : this.type;
    }
    if (this.insuranceMemberId != null) {
      inst['shr.financial.InsuranceMemberId'] = typeof this.insuranceMemberId.toJSON === 'function' ? this.insuranceMemberId.toJSON() : this.insuranceMemberId;
    }
