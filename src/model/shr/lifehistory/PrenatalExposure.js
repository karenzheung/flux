...
class PrenatalExposure extends ExposureToAgent {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/lifehistory/PrenatalExposure' };
    if (this.value != null) {
    ...
    if (this.generalizedTemporalContext != null) {
      inst['shr.core.GeneralizedTemporalContext'] = typeof this.generalizedTemporalContext.toJSON === 'function' ? this.generalizedTemporalContext.toJSON() : this.generalizedTemporalContext;
    }
    return inst;
  }
}
