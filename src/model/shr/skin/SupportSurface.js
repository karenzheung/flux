...
class SupportSurface extends Device {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/skin/SupportSurface' } };
    if (this.value != null) {
    ...
    if (this.deviceUdi != null) {
      inst['shr.device.DeviceUdi'] = this.deviceUdi.map(f => f.toJSON());
    }
    if (this.vendorModelNumber != null) {
      inst['shr.device.VendorModelNumber'] = typeof this.vendorModelNumber.toJSON === 'function' ? this.vendorModelNumber.toJSON() : this.vendorModelNumber;
    }
    if (this.supportSurfaceCategory != null) {
      inst['shr.skin.SupportSurfaceCategory'] = typeof this.supportSurfaceCategory.toJSON === 'function' ? this.supportSurfaceCategory.toJSON() : this.supportSurfaceCategory;
    }
    if (this.supportSurfaceBodyPosition != null) {
      inst['shr.skin.SupportSurfaceBodyPosition'] = typeof this.supportSurfaceBodyPosition.toJSON === 'function' ? this.supportSurfaceBodyPosition.toJSON() : this.supportSurfaceBodyPosition;
    }
    if (this.supportSurfaceComponent != null) {
      inst['shr.skin.SupportSurfaceComponent'] = this.supportSurfaceComponent.map(f => f.toJSON());
    }
    return inst;
  }
}
