...
class SupportSurfaceUsed extends DeviceUsed {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/skin/SupportSurfaceUsed' } };
    if (this.value != null) {
    ...
    if (this.implanted != null) {
      inst['shr.device.Implanted'] = typeof this.implanted.toJSON === 'function' ? this.implanted.toJSON() : this.implanted;
    }
    ...
    if (this.immersionDepth != null) {
      inst['shr.skin.ImmersionDepth'] = typeof this.immersionDepth.toJSON === 'function' ? this.immersionDepth.toJSON() : this.immersionDepth;
    }
    return inst;
  }
}
