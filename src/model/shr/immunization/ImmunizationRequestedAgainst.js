...
class ImmunizationRequestedAgainst extends ImmunizationAction {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/immunization/ImmunizationRequestedAgainst' };
    ...
    if (this.vaccine != null) {
      inst['shr.immunization.Vaccine'] = typeof this.vaccine.toJSON === 'function' ? this.vaccine.toJSON() : this.vaccine;
    }
