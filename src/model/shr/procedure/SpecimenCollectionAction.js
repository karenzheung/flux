...
class SpecimenCollectionAction extends ProcedureAction {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/procedure/SpecimenCollectionAction' } };
    ...
    if (this.amountOrSize != null) {
      inst['shr.procedure.AmountOrSize'] = this.amountOrSize.map(f => f.toJSON());
    }
    return inst;
  }
}
