...
class ImagingProcedurePerformed extends ImagingAction {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/procedure/ImagingProcedurePerformed' };
    ...
    if (this.imagingSubstance != null) {
      inst['shr.procedure.ImagingSubstance'] = this.imagingSubstance.map(f => f.toJSON());
    }
    return inst;
  }
}
