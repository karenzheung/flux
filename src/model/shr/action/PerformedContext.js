...
class PerformedContext extends ActionContext {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/action/PerformedContext' } };
    if (this.reason != null) {
    ...
    if (this.participant != null) {
      inst['shr.action.Participant'] = this.participant.map(f => f.toJSON());
    }
    if (this.status != null) {
      inst['shr.action.Status'] = typeof this.status.toJSON === 'function' ? this.status.toJSON() : this.status;
    }
    if (this.method != null) {
      inst['shr.action.Method'] = typeof this.method.toJSON === 'function' ? this.method.toJSON() : this.method;
    }
    if (this.relatedRequest != null) {
      inst['shr.action.RelatedRequest'] = typeof this.relatedRequest.toJSON === 'function' ? this.relatedRequest.toJSON() : this.relatedRequest;
    }
    if (this.relatedPlan != null) {
      inst['shr.action.RelatedPlan'] = typeof this.relatedPlan.toJSON === 'function' ? this.relatedPlan.toJSON() : this.relatedPlan;
    }
