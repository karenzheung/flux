...
class ParsableContent extends EmbeddedContent {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/ParsableContent' } };
    if (this.value != null) {
      inst['Value'] = this.value;
    }
    if (this.formalism != null) {
      inst['shr.core.Formalism'] = typeof this.formalism.toJSON === 'function' ? this.formalism.toJSON() : this.formalism;
    }
    return inst;
  }
}
