...
class Statistic extends Quantity {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Statistic' } };
    if (this.value != null) {
      inst['Value'] = this.value;
    }
    if (this.comparator != null) {
      inst['shr.core.Comparator'] = typeof this.comparator.toJSON === 'function' ? this.comparator.toJSON() : this.comparator;
    }
    if (this.units != null) {
      inst['shr.core.Units'] = typeof this.units.toJSON === 'function' ? this.units.toJSON() : this.units;
    }
    if (this.statisticType != null) {
      inst['shr.core.StatisticType'] = typeof this.statisticType.toJSON === 'function' ? this.statisticType.toJSON() : this.statisticType;
    }
    return inst;
  }
}
