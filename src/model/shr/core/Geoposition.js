...
class Geoposition {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Geoposition' } };
    if (this.latitude != null) {
      inst['shr.core.Latitude'] = typeof this.latitude.toJSON === 'function' ? this.latitude.toJSON() : this.latitude;
    }
    if (this.longitude != null) {
      inst['shr.core.Longitude'] = typeof this.longitude.toJSON === 'function' ? this.longitude.toJSON() : this.longitude;
    }
    if (this.altitude != null) {
      inst['shr.core.Altitude'] = typeof this.altitude.toJSON === 'function' ? this.altitude.toJSON() : this.altitude;
    }
    return inst;
  }
}
