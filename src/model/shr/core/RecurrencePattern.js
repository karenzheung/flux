...
class RecurrencePattern {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/RecurrencePattern' } };
    if (this.recurrenceInterval != null) {
      inst['shr.core.RecurrenceInterval'] = typeof this.recurrenceInterval.toJSON === 'function' ? this.recurrenceInterval.toJSON() : this.recurrenceInterval;
    }
    if (this.dayOfWeek != null) {
      inst['shr.core.DayOfWeek'] = this.dayOfWeek.map(f => f.toJSON());
    }
    if (this.timeOfDay != null) {
      inst['shr.core.TimeOfDay'] = this.timeOfDay.map(f => f.toJSON());
    }
    if (this.dailyLifeEvent != null) {
      inst['shr.core.DailyLifeEvent'] = this.dailyLifeEvent.map(f => f.toJSON());
    }
    if (this.lifeEventOffset != null) {
      inst['shr.core.LifeEventOffset'] = typeof this.lifeEventOffset.toJSON === 'function' ? this.lifeEventOffset.toJSON() : this.lifeEventOffset;
    }
    if (this.countPerInterval != null) {
      inst['shr.core.CountPerInterval'] = typeof this.countPerInterval.toJSON === 'function' ? this.countPerInterval.toJSON() : this.countPerInterval;
    }
    return inst;
  }
}
