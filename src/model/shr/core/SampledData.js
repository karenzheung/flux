...
class SampledData {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/SampledData' } };
    if (this.value != null) {
      inst['Value'] = this.value;
    }
    if (this.origin != null) {
      inst['shr.core.Origin'] = typeof this.origin.toJSON === 'function' ? this.origin.toJSON() : this.origin;
    }
    if (this.millisecondsBetweenSamples != null) {
      inst['shr.core.MillisecondsBetweenSamples'] = typeof this.millisecondsBetweenSamples.toJSON === 'function' ? this.millisecondsBetweenSamples.toJSON() : this.millisecondsBetweenSamples;
    }
    if (this.correctionFactor != null) {
      inst['shr.core.CorrectionFactor'] = typeof this.correctionFactor.toJSON === 'function' ? this.correctionFactor.toJSON() : this.correctionFactor;
    }
    if (this.lowerLimit != null) {
      inst['shr.core.LowerLimit'] = typeof this.lowerLimit.toJSON === 'function' ? this.lowerLimit.toJSON() : this.lowerLimit;
    }
    if (this.upperLimit != null) {
      inst['shr.core.UpperLimit'] = typeof this.upperLimit.toJSON === 'function' ? this.upperLimit.toJSON() : this.upperLimit;
    }
    if (this.dimensions != null) {
      inst['shr.core.Dimensions'] = typeof this.dimensions.toJSON === 'function' ? this.dimensions.toJSON() : this.dimensions;
    }
    return inst;
  }
}
