...
class CountPerInterval {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/CountPerInterval' } };
    if (this.minCount != null) {
      inst['shr.core.MinCount'] = typeof this.minCount.toJSON === 'function' ? this.minCount.toJSON() : this.minCount;
    }
    if (this.maxCount != null) {
      inst['shr.core.MaxCount'] = typeof this.maxCount.toJSON === 'function' ? this.maxCount.toJSON() : this.maxCount;
    }
    return inst;
  }
}
