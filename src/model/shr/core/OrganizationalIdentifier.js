...
class OrganizationalIdentifier extends Identifier {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/OrganizationalIdentifier' } };
    if (this.value != null) {
    ...
    if (this.codeSystem != null) {
      inst['shr.core.CodeSystem'] = typeof this.codeSystem.toJSON === 'function' ? this.codeSystem.toJSON() : this.codeSystem;
    }
    ...
    if (this.issuer != null) {
      inst['shr.entity.Issuer'] = typeof this.issuer.toJSON === 'function' ? this.issuer.toJSON() : this.issuer;
    }
    if (this.timePeriod != null) {
      inst['shr.core.TimePeriod'] = typeof this.timePeriod.toJSON === 'function' ? this.timePeriod.toJSON() : this.timePeriod;
    }
    if (this.organization != null) {
      inst['shr.entity.Organization'] = typeof this.organization.toJSON === 'function' ? this.organization.toJSON() : this.organization;
    }
    return inst;
  }
}
