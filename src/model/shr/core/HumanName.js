...
class HumanName {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/HumanName' } };
    if (this.value != null) {
      inst['Value'] = this.value;
    }
    if (this.humanNamePrefix != null) {
      inst['shr.core.HumanNamePrefix'] = typeof this.humanNamePrefix.toJSON === 'function' ? this.humanNamePrefix.toJSON() : this.humanNamePrefix;
    }
    if (this.givenName != null) {
      inst['shr.core.GivenName'] = this.givenName.map(f => f.toJSON());
    }
    if (this.familyName != null) {
      inst['shr.core.FamilyName'] = typeof this.familyName.toJSON === 'function' ? this.familyName.toJSON() : this.familyName;
    }
    if (this.humanNameSuffix != null) {
      inst['shr.core.HumanNameSuffix'] = this.humanNameSuffix.map(f => f.toJSON());
    }
