...
class Signature {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/core/Signature' } };
    if (this.typeAsaCoding != null) {
      inst['shr.core.TypeAsaCoding'] = this.typeAsaCoding.map(f => f.toJSON());
    }
    ...
    if (this.signatory != null) {
      inst['shr.core.Signatory'] = typeof this.signatory.toJSON === 'function' ? this.signatory.toJSON() : this.signatory;
    }
    if (this.onBehalfOf != null) {
      inst['shr.core.OnBehalfOf'] = typeof this.onBehalfOf.toJSON === 'function' ? this.onBehalfOf.toJSON() : this.onBehalfOf;
    }
