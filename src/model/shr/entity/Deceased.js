...
class Deceased {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Deceased' } };
    if (this.value != null) {
      inst['Value'] = this.value;
    }
    if (this.dateOfDeath != null) {
      inst['shr.entity.DateOfDeath'] = typeof this.dateOfDeath.toJSON === 'function' ? this.dateOfDeath.toJSON() : this.dateOfDeath;
    }
    if (this.ageAtDeath != null) {
      inst['shr.entity.AgeAtDeath'] = typeof this.ageAtDeath.toJSON === 'function' ? this.ageAtDeath.toJSON() : this.ageAtDeath;
    }
    return inst;
  }
}
