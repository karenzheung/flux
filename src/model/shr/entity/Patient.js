...
class Patient extends Role {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Patient' };
    if (this.value != null) {
    ...
    if (this.medicalRecordNumber != null) {
      inst['shr.entity.MedicalRecordNumber'] = this.medicalRecordNumber.map(f => f.toJSON());
    }
    if (this.placeOfBirth != null) {
      inst['shr.entity.PlaceOfBirth'] = typeof this.placeOfBirth.toJSON === 'function' ? this.placeOfBirth.toJSON() : this.placeOfBirth;
    }
    if (this.multipleBirth != null) {
      inst['shr.entity.MultipleBirth'] = typeof this.multipleBirth.toJSON === 'function' ? this.multipleBirth.toJSON() : this.multipleBirth;
    }
    if (this.birthSex != null) {
      inst['shr.entity.BirthSex'] = typeof this.birthSex.toJSON === 'function' ? this.birthSex.toJSON() : this.birthSex;
    }
    if (this.race != null) {
      inst['shr.entity.Race'] = typeof this.race.toJSON === 'function' ? this.race.toJSON() : this.race;
    }
    if (this.ethnicity != null) {
      inst['shr.entity.Ethnicity'] = typeof this.ethnicity.toJSON === 'function' ? this.ethnicity.toJSON() : this.ethnicity;
    }
    if (this.maritalStatus != null) {
      inst['shr.entity.MaritalStatus'] = typeof this.maritalStatus.toJSON === 'function' ? this.maritalStatus.toJSON() : this.maritalStatus;
    }
    if (this.mothersMaidenName != null) {
      inst['shr.entity.MothersMaidenName'] = typeof this.mothersMaidenName.toJSON === 'function' ? this.mothersMaidenName.toJSON() : this.mothersMaidenName;
    }
    if (this.fathersName != null) {
      inst['shr.entity.FathersName'] = typeof this.fathersName.toJSON === 'function' ? this.fathersName.toJSON() : this.fathersName;
    }
    if (this.socialSecurityNumber != null) {
      inst['shr.entity.SocialSecurityNumber'] = typeof this.socialSecurityNumber.toJSON === 'function' ? this.socialSecurityNumber.toJSON() : this.socialSecurityNumber;
    }
    if (this.driversLicenseNumber != null) {
      inst['shr.entity.DriversLicenseNumber'] = typeof this.driversLicenseNumber.toJSON === 'function' ? this.driversLicenseNumber.toJSON() : this.driversLicenseNumber;
    }
    if (this.passportNumber != null) {
      inst['shr.entity.PassportNumber'] = this.passportNumber.map(f => f.toJSON());
    }
    if (this.medicalInterpreterNeeded != null) {
      inst['shr.entity.MedicalInterpreterNeeded'] = typeof this.medicalInterpreterNeeded.toJSON === 'function' ? this.medicalInterpreterNeeded.toJSON() : this.medicalInterpreterNeeded;
    }
    if (this.deceased != null) {
      inst['shr.entity.Deceased'] = typeof this.deceased.toJSON === 'function' ? this.deceased.toJSON() : this.deceased;
    }
    return inst;
  }
}
