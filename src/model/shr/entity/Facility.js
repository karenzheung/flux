...
class Facility extends Entity {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Facility' };
    ...
    if (this.facilityName != null) {
      inst['shr.entity.FacilityName'] = typeof this.facilityName.toJSON === 'function' ? this.facilityName.toJSON() : this.facilityName;
    }
    ...
    if (this.mobileFacility != null) {
      inst['shr.entity.MobileFacility'] = typeof this.mobileFacility.toJSON === 'function' ? this.mobileFacility.toJSON() : this.mobileFacility;
    }
    if (this.contactPoint != null) {
      inst['shr.core.ContactPoint'] = typeof this.contactPoint.toJSON === 'function' ? this.contactPoint.toJSON() : this.contactPoint;
    }
    if (this.managingOrganization != null) {
      inst['shr.entity.ManagingOrganization'] = typeof this.managingOrganization.toJSON === 'function' ? this.managingOrganization.toJSON() : this.managingOrganization;
    }
    return inst;
  }
}
