...
class ExternalHealthRecord extends Entity {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/ExternalHealthRecord' } };
    ...
    if (this.accessTime != null) {
      inst['shr.entity.AccessTime'] = typeof this.accessTime.toJSON === 'function' ? this.accessTime.toJSON() : this.accessTime;
    }
    return inst;
  }
}
