...
class Ethnicity {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Ethnicity' } };
    if (this.value != null) {
      inst['Value'] = typeof this.value.toJSON === 'function' ? this.value.toJSON() : this.value;
    }
    if (this.ethnicityDetail != null) {
      inst['shr.entity.EthnicityDetail'] = this.ethnicityDetail.map(f => f.toJSON());
    }
    return inst;
  }
}
