...
class Substance extends Entity {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Substance' };
    ...
    if (this.activeFlagAsaCodeableConcept != null) {
      inst['shr.entity.ActiveFlagAsaCodeableConcept'] = typeof this.activeFlagAsaCodeableConcept.toJSON === 'function' ? this.activeFlagAsaCodeableConcept.toJSON() : this.activeFlagAsaCodeableConcept;
    }
    if (this.details != null) {
      inst['shr.core.Details'] = typeof this.details.toJSON === 'function' ? this.details.toJSON() : this.details;
    }
    if (this.ingredient != null) {
      inst['shr.entity.Ingredient'] = this.ingredient.map(f => f.toJSON());
    }
    return inst;
  }
}
