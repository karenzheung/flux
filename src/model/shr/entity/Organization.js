...
class Organization extends Entity {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Organization' };
    ...
    if (this.organizationName != null) {
      inst['shr.entity.OrganizationName'] = typeof this.organizationName.toJSON === 'function' ? this.organizationName.toJSON() : this.organizationName;
    }
    if (this.organizationAlias != null) {
      inst['shr.entity.OrganizationAlias'] = this.organizationAlias.map(f => f.toJSON());
    }
    if (this.organizationIdentifier != null) {
      inst['shr.entity.OrganizationIdentifier'] = this.organizationIdentifier.map(f => f.toJSON());
    }
