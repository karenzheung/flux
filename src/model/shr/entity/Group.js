...
class Group extends Entity {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Group' };
    ...
    if (this.definitional != null) {
      inst['shr.core.Definitional'] = typeof this.definitional.toJSON === 'function' ? this.definitional.toJSON() : this.definitional;
    }
    if (this.membershipCriterion != null) {
      inst['shr.entity.MembershipCriterion'] = this.membershipCriterion.map(f => f.toJSON());
    }
    if (this.member != null) {
      inst['shr.entity.Member'] = this.member.map(f => f.toJSON());
    }
    if (this.count != null) {
      inst['shr.core.Count'] = typeof this.count.toJSON === 'function' ? this.count.toJSON() : this.count;
    }
    return inst;
  }
}
