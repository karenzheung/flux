...
class Medication extends Entity {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Medication' };
    ...
    if (this.doseForm != null) {
      inst['shr.entity.DoseForm'] = typeof this.doseForm.toJSON === 'function' ? this.doseForm.toJSON() : this.doseForm;
    }
    if (this.brand != null) {
      inst['shr.entity.Brand'] = typeof this.brand.toJSON === 'function' ? this.brand.toJSON() : this.brand;
    }
    if (this.overTheCounter != null) {
      inst['shr.entity.OverTheCounter'] = typeof this.overTheCounter.toJSON === 'function' ? this.overTheCounter.toJSON() : this.overTheCounter;
    }
    if (this.medicationIngredient != null) {
      inst['shr.entity.MedicationIngredient'] = this.medicationIngredient.map(f => f.toJSON());
    }
    if (this.manufacturer != null) {
      inst['shr.entity.Manufacturer'] = typeof this.manufacturer.toJSON === 'function' ? this.manufacturer.toJSON() : this.manufacturer;
    }
    if (this.lotNumber != null) {
      inst['shr.entity.LotNumber'] = typeof this.lotNumber.toJSON === 'function' ? this.lotNumber.toJSON() : this.lotNumber;
    }
    if (this.expirationDate != null) {
      inst['shr.entity.ExpirationDate'] = typeof this.expirationDate.toJSON === 'function' ? this.expirationDate.toJSON() : this.expirationDate;
    }
    if (this.package != null) {
      inst['shr.entity.Package'] = typeof this.package.toJSON === 'function' ? this.package.toJSON() : this.package;
    }
    return inst;
  }
}
