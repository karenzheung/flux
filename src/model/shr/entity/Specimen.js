...
class Specimen extends Entity {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Specimen' };
    ...
    if (this.accessionIdentifier != null) {
      inst['shr.entity.AccessionIdentifier'] = typeof this.accessionIdentifier.toJSON === 'function' ? this.accessionIdentifier.toJSON() : this.accessionIdentifier;
    }
    if (this.status != null) {
    ...
    if (this.sourceSpecimen != null) {
      inst['shr.entity.SourceSpecimen'] = typeof this.sourceSpecimen.toJSON === 'function' ? this.sourceSpecimen.toJSON() : this.sourceSpecimen;
    }
    ...
    if (this.specimenCollectionPerformed != null) {
      inst['shr.procedure.SpecimenCollectionPerformed'] = typeof this.specimenCollectionPerformed.toJSON === 'function' ? this.specimenCollectionPerformed.toJSON() : this.specimenCollectionPerformed;
    }
    if (this.specimenContainer != null) {
      inst['shr.entity.SpecimenContainer'] = this.specimenContainer.map(f => f.toJSON());
    }
    if (this.specimenTreatment != null) {
      inst['shr.entity.SpecimenTreatment'] = this.specimenTreatment.map(f => f.toJSON());
    }
    if (this.handlingRisk != null) {
      inst['shr.entity.HandlingRisk'] = this.handlingRisk.map(f => f.toJSON());
    }
    if (this.specialHandling != null) {
      inst['shr.entity.SpecialHandling'] = this.specialHandling.map(f => f.toJSON());
    }
    return inst;
  }
}
