...
class Brand {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Brand' } };
    if (this.value != null) {
      inst['Value'] = this.value;
    }
    if (this.brandName != null) {
      inst['shr.entity.BrandName'] = typeof this.brandName.toJSON === 'function' ? this.brandName.toJSON() : this.brandName;
    }
    return inst;
  }
}
