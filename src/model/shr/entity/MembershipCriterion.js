...
class MembershipCriterion {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/MembershipCriterion' } };
    if (this.value != null) {
    ...
    if (this.excludeFlag != null) {
      inst['shr.entity.ExcludeFlag'] = typeof this.excludeFlag.toJSON === 'function' ? this.excludeFlag.toJSON() : this.excludeFlag;
    }
