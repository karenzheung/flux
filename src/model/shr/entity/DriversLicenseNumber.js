...
class DriversLicenseNumber {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/DriversLicenseNumber' } };
    if (this.value != null) {
      inst['Value'] = this.value;
    }
    if (this.stateOfIssue != null) {
      inst['shr.entity.StateOfIssue'] = typeof this.stateOfIssue.toJSON === 'function' ? this.stateOfIssue.toJSON() : this.stateOfIssue;
    }
