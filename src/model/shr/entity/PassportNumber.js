...
class PassportNumber {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/PassportNumber' } };
    if (this.value != null) {
      inst['Value'] = this.value;
    }
    if (this.countryOfIssue != null) {
      inst['shr.entity.CountryOfIssue'] = typeof this.countryOfIssue.toJSON === 'function' ? this.countryOfIssue.toJSON() : this.countryOfIssue;
    }
