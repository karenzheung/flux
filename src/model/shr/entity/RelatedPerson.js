...
class RelatedPerson extends Role {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/RelatedPerson' };
    if (this.value != null) {
    ...
    if (this.relationshipType != null) {
      inst['shr.entity.RelationshipType'] = typeof this.relationshipType.toJSON === 'function' ? this.relationshipType.toJSON() : this.relationshipType;
    }
