...
class BodySite extends Entity {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/BodySite' } };
    if (this.value != null) {
    ...
    if (this.laterality != null) {
      inst['shr.entity.Laterality'] = typeof this.laterality.toJSON === 'function' ? this.laterality.toJSON() : this.laterality;
    }
    if (this.directionality != null) {
      inst['shr.entity.Directionality'] = typeof this.directionality.toJSON === 'function' ? this.directionality.toJSON() : this.directionality;
    }
    if (this.portionTotality != null) {
      inst['shr.entity.PortionTotality'] = typeof this.portionTotality.toJSON === 'function' ? this.portionTotality.toJSON() : this.portionTotality;
    }
    if (this.clockDirection != null) {
      inst['shr.core.ClockDirection'] = typeof this.clockDirection.toJSON === 'function' ? this.clockDirection.toJSON() : this.clockDirection;
    }
    if (this.distance != null) {
      inst['shr.core.Distance'] = typeof this.distance.toJSON === 'function' ? this.distance.toJSON() : this.distance;
    }
    ...
    if (this.bodySiteMarker != null) {
      inst['shr.entity.BodySiteMarker'] = typeof this.bodySiteMarker.toJSON === 'function' ? this.bodySiteMarker.toJSON() : this.bodySiteMarker;
    }
    return inst;
  }
}
