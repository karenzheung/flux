...
class Practitioner extends Role {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Practitioner' } };
    if (this.value != null) {
    ...
    if (this.nationalProviderIdentifier != null) {
      inst['shr.entity.NationalProviderIdentifier'] = typeof this.nationalProviderIdentifier.toJSON === 'function' ? this.nationalProviderIdentifier.toJSON() : this.nationalProviderIdentifier;
    }
    if (this.qualification != null) {
      inst['shr.entity.Qualification'] = this.qualification.map(f => f.toJSON());
    }
    return inst;
  }
}
