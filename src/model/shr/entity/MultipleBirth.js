...
class MultipleBirth {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/MultipleBirth' } };
    if (this.value != null) {
      inst['Value'] = this.value;
    }
    if (this.multipleBirthOrder != null) {
      inst['shr.entity.MultipleBirthOrder'] = typeof this.multipleBirthOrder.toJSON === 'function' ? this.multipleBirthOrder.toJSON() : this.multipleBirthOrder;
    }
    return inst;
  }
}
