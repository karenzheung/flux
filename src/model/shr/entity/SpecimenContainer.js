...
class SpecimenContainer extends Entity {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/SpecimenContainer' };
    ...
    if (this.capacity != null) {
      inst['shr.entity.Capacity'] = typeof this.capacity.toJSON === 'function' ? this.capacity.toJSON() : this.capacity;
    }
    if (this.specimenQuantity != null) {
      inst['shr.entity.SpecimenQuantity'] = typeof this.specimenQuantity.toJSON === 'function' ? this.specimenQuantity.toJSON() : this.specimenQuantity;
    }
    if (this.additive != null) {
      inst['shr.entity.Additive'] = this.additive.map(f => f.toJSON());
    }
    if (this.sequenceNumber != null) {
      inst['shr.entity.SequenceNumber'] = typeof this.sequenceNumber.toJSON === 'function' ? this.sequenceNumber.toJSON() : this.sequenceNumber;
    }
    return inst;
  }
}
