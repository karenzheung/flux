...
class Person extends Entity {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/Person' };
    ...
    if (this.humanName != null) {
      inst['shr.core.HumanName'] = this.humanName.map(f => f.toJSON());
    }
    if (this.anonymizedFlag != null) {
      inst['shr.entity.AnonymizedFlag'] = typeof this.anonymizedFlag.toJSON === 'function' ? this.anonymizedFlag.toJSON() : this.anonymizedFlag;
    }
    if (this.fictionalPersonFlag != null) {
      inst['shr.entity.FictionalPersonFlag'] = typeof this.fictionalPersonFlag.toJSON === 'function' ? this.fictionalPersonFlag.toJSON() : this.fictionalPersonFlag;
    }
    if (this.dateOfBirth != null) {
      inst['shr.entity.DateOfBirth'] = typeof this.dateOfBirth.toJSON === 'function' ? this.dateOfBirth.toJSON() : this.dateOfBirth;
    }
    if (this.administrativeGender != null) {
      inst['shr.entity.AdministrativeGender'] = typeof this.administrativeGender.toJSON === 'function' ? this.administrativeGender.toJSON() : this.administrativeGender;
    }
    if (this.address != null) {
      inst['shr.core.Address'] = this.address.map(f => f.toJSON());
    }
    if (this.headshot != null) {
      inst['shr.entity.Headshot'] = typeof this.headshot.toJSON === 'function' ? this.headshot.toJSON() : this.headshot;
    }
    if (this.contactPoint != null) {
      inst['shr.core.ContactPoint'] = this.contactPoint.map(f => f.toJSON());
    }
    if (this.languageUsed != null) {
      inst['shr.entity.LanguageUsed'] = this.languageUsed.map(f => f.toJSON());
    }
    if (this.activeFlag != null) {
      inst['shr.entity.ActiveFlag'] = typeof this.activeFlag.toJSON === 'function' ? this.activeFlag.toJSON() : this.activeFlag;
    }
    if (this.externalHealthRecord != null) {
      inst['shr.entity.ExternalHealthRecord'] = this.externalHealthRecord.map(f => f.toJSON());
    }
    return inst;
  }
}
