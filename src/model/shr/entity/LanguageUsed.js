...
class LanguageUsed {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/entity/LanguageUsed' } };
    if (this.value != null) {
      inst['Value'] = typeof this.value.toJSON === 'function' ? this.value.toJSON() : this.value;
    }
    if (this.spokenLanguageProficiency != null) {
      inst['shr.entity.SpokenLanguageProficiency'] = typeof this.spokenLanguageProficiency.toJSON === 'function' ? this.spokenLanguageProficiency.toJSON() : this.spokenLanguageProficiency;
    }
    if (this.writtenLanguageProficiency != null) {
      inst['shr.entity.WrittenLanguageProficiency'] = typeof this.writtenLanguageProficiency.toJSON === 'function' ? this.writtenLanguageProficiency.toJSON() : this.writtenLanguageProficiency;
    }
    if (this.languageQualifier != null) {
      inst['shr.entity.LanguageQualifier'] = this.languageQualifier.map(f => f.toJSON());
    }
    return inst;
  }
}
