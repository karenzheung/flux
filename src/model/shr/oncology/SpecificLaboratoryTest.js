...
class SpecificLaboratoryTest extends FindingMethod {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/oncology/SpecificLaboratoryTest' } };
    if (this.value != null) {
    ...
    if (this.certifiedBy != null) {
      inst['shr.oncology.CertifiedBy'] = typeof this.certifiedBy.toJSON === 'function' ? this.certifiedBy.toJSON() : this.certifiedBy;
    }
    return inst;
  }
}
