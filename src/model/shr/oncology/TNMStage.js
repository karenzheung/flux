...
class TNMStage extends Observation {
  ...
  toJSON() {
    ...
    inst['shr.base.EntryType'] = { 'Value' : 'http://standardhealthrecord.org/spec/shr/oncology/TNMStage' };
    if (this.value != null) {
    ...
    if (this.stagingTiming != null) {
      inst['shr.oncology.StagingTiming'] = typeof this.stagingTiming.toJSON === 'function' ? this.stagingTiming.toJSON() : this.stagingTiming;
    }
    return inst;
  }
}
