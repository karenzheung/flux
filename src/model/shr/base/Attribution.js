...
class Attribution {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/base/Attribution' } };
    if (this.role != null) {
      inst['shr.entity.Role'] = typeof this.role.toJSON === 'function' ? this.role.toJSON() : this.role;
    }
