...
class Narrative {
   ...
   */
  toJSON() {
    const inst = { 'shr.base.EntryType': { 'Value' : 'http://standardhealthrecord.org/spec/shr/base/Narrative' } };
    if (this.value != null) {
      inst['Value'] = this.value;
    }
    if (this.narrativeQualifier != null) {
      inst['shr.base.NarrativeQualifier'] = typeof this.narrativeQualifier.toJSON === 'function' ? this.narrativeQualifier.toJSON() : this.narrativeQualifier;
    }
    return inst;
  }
}
